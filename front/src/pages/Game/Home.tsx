...
const Home = () => {
    const play = (event: React.MouseEvent<HTMLButtonElement>): void => {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-4">
            ...
            <ClickButton name="Jogar" defaultStyles="animate-btsHome cursor-pointer text-[30px] font-bold bg-yellow text-purple-2 w-full h-[72px] rounded-[10px] tracking-[1px] uppercase"
            clickStyles="bg-yellow-2" onClick={play}/>
        </div>
    );
}
