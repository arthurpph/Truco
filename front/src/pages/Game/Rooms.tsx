...
const Rooms = () => {
    ...
    return (
        <div className="flex flex-col h-full rounded-game-border select-none">
            <div className="flex items-center justify-center bg-orange-3 h-[148px] rounded-game-border">
                <h1 className="font-open-sans-semibold font-bold text-white text-[35px] select-none">Salas</h1>
            </div>
            <div className="bg-white-2 flex justify-between h-full rounded-b-game-border gap-10">
                <div className="bg-white flex flex-col items-center justify-center gap-8 w-[280px] h-[93%] mt-5 ml-3 rounded-game-border border-[3px] border-[#ff5700]">
                ...
                <div className="w-[76%] h-full max-h-[600px] flex flex-wrap content-start overflow-auto mt-[20px] custom-scroll">
                    {rooms.length > 0 ? (
                        rooms.map((room) => (
                            <div key={room.id} className="flex flex-col items-center bg-white w-[229px] h-[240px] mr-[30px] rounded-game-border border-gray-300 active:border-2">
